...
class StructuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create structure" do
    assert_difference('Structure.count') do
      post structures_url, params: { structure: { contact: @structure.contact, email: @structure.email, name: @structure.name, variety: @structure.variety } }
    end
  ...
  test "should update structure" do
    patch structure_url(@structure), params: { structure: { contact: @structure.contact, email: @structure.email, name: @structure.name, variety: @structure.variety } }
